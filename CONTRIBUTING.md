Contributing to Comma Core
==================================

The Comma Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Comma Core project, and is not to be
confused with overall Comma Network Protocol consensus changes.

Whether a pull request is merged into Comma Core rests with the project merge
...
Patches that change Comma consensus rules are considerably more involved than
...
Where a patch set proposes to change the Comma consensus, it must have been
...
The project leader is the release manager for each Comma Core release.
