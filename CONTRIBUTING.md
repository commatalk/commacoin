Contributing to COMMACOIN Core
============================

The COMMACOIN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the COMMACOIN Core project, and is not to be
confused with overall COMMACOIN Network Protocol consensus changes.

Whether a pull request is merged into COMMACOIN Core rests with the project merge
...
Patches that change COMMACOIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the COMMACOIN consensus, it must have been
...
The project leader is the release manager for each COMMACOIN Core release.
