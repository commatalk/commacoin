...
pkgdatadir = $(datadir)/commacoin
pkgincludedir = $(includedir)/commacoin
pkglibdir = $(libdir)/commacoin
pkglibexecdir = $(libexecdir)/commacoin
...
CONFIG_HEADER = $(top_builddir)/src/config/commacoin-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/commacoin-config.h.in \
...
ACLOCAL = ${SHELL} /home/geunwon/projects/commacoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/geunwon/projects/commacoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/geunwon/projects/commacoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/geunwon/projects/commacoin/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CMC_NAME = commacoin-cli
BITCOIN_DAEMON_NAME = commacoind
BITCOIN_GUI_NAME = commacoin-qt
BITCOIN_TX_NAME = commacoin-tx
...
CFLAGS = -g -O2
CMCENT_VERSION_BUILD = 0
CMCENT_VERSION_IS_RELEASE = true
CMCENT_VERSION_MAJOR = 1
CMCENT_VERSION_MINOR = 0
CMCENT_VERSION_REVISION = 0
...
MAINT = 
MAKEINFO = ${SHELL} /home/geunwon/projects/commacoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = commacoin
PACKAGE_BUGREPORT = www.commacoin.org
PACKAGE_NAME = Commacoin Core
PACKAGE_STRING = Commacoin Core 1.0.0
PACKAGE_TARNAME = commacoin
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/geunwon/projects/commacoin
abs_srcdir = /home/geunwon/projects/commacoin
abs_top_builddir = /home/geunwon/projects/commacoin
abs_top_srcdir = /home/geunwon/projects/commacoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/geunwon/projects/commacoin/build-aux/install-sh
...
BITCOIN_CMC_BIN = $(top_builddir)/src/$(BITCOIN_CMC_NAME)$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = COMMACOIN-Qt.app
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_commacoin_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_commacoin_coverage.info test_commacoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/COMMACOIN-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/commacoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/commacoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/commacoin-config.h
$(top_srcdir)/src/config/commacoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/commacoin-config.h src/config/stamp-h1
...
$(BITCOIN_WIN_INSTALLER): all-recursive
	...
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(BITCOIN_CMC_BIN) $(top_builddir)/release
...
$(OSX_APP)/Contents/MacOS/COMMACOIN-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/COMMACOIN-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/COMMACOIN-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_commacoin.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_commacoin -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_commacoin_filtered.info: test_commacoin.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_commacoin_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_commacoin_coverage.info: baseline_filtered_combined.info test_commacoin_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_commacoin_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_commacoin_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_commacoin_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_commacoin.coverage/.dirstamp:  test_commacoin_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_commacoin.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_commacoin.coverage/ total.coverage/ $(OSX_APP)
