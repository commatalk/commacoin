...
static const std::string TOR_SAFE_CMCENTKEY = "Tor safe cookie authentication controller-to-server hash";
...
void TorController::authchallenge_cb(TorControlConnection& _conn, const TorControlReply& reply)
{
    if (reply.code == 250) {
        ...
        if (l.first == "AUTHCHALLENGE") {
            ...
            std::vector<uint8_t> computedClientHash = ComputeResponse(TOR_SAFE_CMCENTKEY, cookie, clientNonce, serverNonce);
