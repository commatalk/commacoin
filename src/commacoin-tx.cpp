...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Civx Core commacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  commacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded commacoin transaction") + "\n" +
                               "  commacoin-tx [options] -create [commands]   " + _("Create hex-encoded commacoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded commacoin transaction
