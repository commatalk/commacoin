...
#ifndef COMMACOIN_STAKEINPUT_H
#define COMMACOIN_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZCMC() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zCMCStake can take two forms
...
public:
    ...
    bool IsZCMC() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZCMC() override { return false; }
};


#endif //COMMACOIN_STAKEINPUT_H
