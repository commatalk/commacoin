...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop COMMACOIN server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "COMMACOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* COMMACOIN features */
        {"commacoin", "masternode", &masternode, true, true, false},
        {"commacoin", "listmasternodes", &listmasternodes, true, true, false},
        {"commacoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"commacoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"commacoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"commacoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"commacoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"commacoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"commacoin", "masternodedebug", &masternodedebug, true, true, false},
        {"commacoin", "startmasternode", &startmasternode, true, true, false},
        {"commacoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"commacoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"commacoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"commacoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"commacoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"commacoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"commacoin", "mnbudget", &mnbudget, true, true, false},
        {"commacoin", "preparebudget", &preparebudget, true, true, false},
        {"commacoin", "submitbudget", &submitbudget, true, true, false},
        {"commacoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"commacoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"commacoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"commacoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"commacoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"commacoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"commacoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"commacoin", "checkbudgets", &checkbudgets, true, true, false},
        {"commacoin", "mnsync", &mnsync, true, true, false},
        {"commacoin", "spork", &spork, true, true, false},
        {"commacoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> commacoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:25717/\n";
}
