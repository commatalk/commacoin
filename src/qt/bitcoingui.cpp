                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("COMMACOIN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a COMMACOIN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and commacoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCMC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About COMMACOIN Core"), this);
    aboutAction->setStatusTip(tr("Show information about COMMACOIN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for COMMACOIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your COMMACOIN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified COMMACOIN addresses"));
    ...
    openAction->setStatusTip(tr("Open a COMMACOIN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the COMMACOIN Core help message to get a list with possible COMMACOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("COMMACOIN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to COMMACOIN network", "", count));
}
...
{
    QString strTitle = tr("COMMACOIN Core"); // default title
