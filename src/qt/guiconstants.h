...
/* Civx GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "COMMACOIN"
#define QAPP_ORG_DOMAIN "commacoin.org"
#define QAPP_APP_NAME_DEFAULT "COMMACOIN-Qt"
#define QAPP_APP_NAME_TESTNET "COMMACOIN-Qt-testnet"
