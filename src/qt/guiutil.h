...
/** Utility functions used by the COMMACOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render COMMACOIN addresses in monospace font
...
// Parse "commacoin:" URI into recipient object, return true on successful parsing
