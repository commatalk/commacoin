...
/** Utility functions used by the Comma Qt UI.
 */
namespace GUIUtil
{
...
// Render CMC addresses in monospace font
...
// Parse "comma:" URI into recipient object, return true on successful parsing
