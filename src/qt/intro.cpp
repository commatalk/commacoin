...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("COMMACOIN Core"),
     ...
     * override -datadir in the commacoin.conf file in the default data directory
     * (to be consistent with commacoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
