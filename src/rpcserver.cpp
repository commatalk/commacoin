...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Comma features */
        {"comma", "masternode", &masternode, true, true, false},
        {"comma", "listmasternodes", &listmasternodes, true, true, false},
        {"comma", "getmasternodecount", &getmasternodecount, true, true, false},
        {"comma", "masternodeconnect", &masternodeconnect, true, true, false},
        {"comma", "masternodecurrent", &masternodecurrent, true, true, false},
        {"comma", "masternodedebug", &masternodedebug, true, true, false},
        {"comma", "startmasternode", &startmasternode, true, true, false},
        {"comma", "createmasternodekey", &createmasternodekey, true, true, false},
        {"comma", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"comma", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"comma", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"comma", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"comma", "getmasternodescores", &getmasternodescores, true, true, false},
        {"comma", "mnbudget", &mnbudget, true, true, false},
        {"comma", "preparebudget", &preparebudget, true, true, false},
        {"comma", "submitbudget", &submitbudget, true, true, false},
        {"comma", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"comma", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"comma", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"comma", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"comma", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"comma", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"comma", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"comma", "checkbudgets", &checkbudgets, true, true, false},
        {"comma", "mnsync", &mnsync, true, true, false},
        {"comma", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> comma-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:14521/\n";
}
