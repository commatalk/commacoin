...
#   c) node1 mines 32 blocks, so now node 0 has 500000CMC, node 1 has 4250CMC, node2 has none.
#   d) node0 sends 601 CMC to node2, in two transactions (301 CMC, then 300 CMC).
