...
RESOURCES += src/qt/comma.qrc src/qt/comma_locale.qrc

TRANSLATIONS += src/qt/locale/comma_bg.ts \
                src/qt/locale/comma_de.ts \
                src/qt/locale/comma_en.ts \
                src/qt/locale/comma_es.ts \
                src/qt/locale/comma_fi.ts \
                src/qt/locale/comma_fr.ts \
                src/qt/locale/comma_it.ts \
                src/qt/locale/comma_ja.ts \
                src/qt/locale/comma_pl.ts \
                src/qt/locale/comma_pt.ts \
                src/qt/locale/comma_ru.ts \
                src/qt/locale/comma_sk.ts \
                src/qt/locale/comma_sv.ts \
                src/qt/locale/comma_vi.ts \
                src/qt/locale/comma_zh_CN.ts \
                src/qt/locale/comma_zh_TW.ts
