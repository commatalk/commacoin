...
This means one can have an always-on commacoind instance running, and another local commacoind/commacoin-qt instance which connects to this node and receives blocks from it.
