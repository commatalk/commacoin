...
Intro
-----
Comma (CMC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Comma utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run comma-qt.exe.

Comma Core is the original Comma client and it builds the backbone of the network.
However, it downloads and stores the entire history of Comma transactions;
