...
In order to support loading of multiple wallets in comma-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is comma.cpp.
...
Changes to comma.cpp
----------------------
comma.cpp is the entry point into comma-qt, and as such, will require some minor modifications to provide hooks for
