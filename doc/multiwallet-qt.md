...
In order to support loading of multiple wallets in commacoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is commacoin.cpp.
...
Changes to commacoin.cpp
----------------------
commacoin.cpp is the entry point into commacoin-qt, and as such, will require some minor modifications to provide hooks for
